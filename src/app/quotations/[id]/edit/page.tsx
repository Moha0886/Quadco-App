    ...
    try {
      ...
      if (quotationRes.ok) {
        ...
        setFormData({
          ...
          validUntil: quotationData.validUntil.split('T')[0],
          status: quotationData.status,
          notes: quotationData.notes || "",
        });
        setLineItems(quotationData.lineItems.map((item: any) => ({
          id: item.id,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Failed to update quotation: ${error.error}`);
      }
    } catch (error) {
          ...
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Edit Quotation QUO-{quotation.id.slice(-6).toUpperCase()}
              </h1>
